...
DECLARE_ALGORITHM(JsubHelloAlg);

JsubHelloAlg::JsubHelloAlg(const std::string& name)
    : AlgBase(name)
{
    m_count = 0;
...
JsubHelloAlg::~JsubHelloAlg()
{
}

bool JsubHelloAlg::initialize()
{

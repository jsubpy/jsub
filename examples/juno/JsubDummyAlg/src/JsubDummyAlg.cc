...
#include "JsubDummyAlg.h"
#include "JsubDummyTool.h"
#include "SniperKernel/AlgFactory.h"
#include "SniperKernel/SniperPtr.h"
#include "RootWriter/RootWriter.h"
#include "TTree.h"

DECLARE_ALGORITHM(JsubDummyAlg);

JsubDummyAlg::JsubDummyAlg(const std::string& name)
    : AlgBase(name)
{
    m_iEvt = 0;
}

JsubDummyAlg::~JsubDummyAlg()
{
}

bool JsubDummyAlg::initialize()
{
...
bool JsubDummyAlg::execute()
{
    ...
    //call a tool
    JsubDummyTool* ptool = tool<JsubDummyTool>("dtool");
    ptool->doSomeThing();

    return true;
}

bool JsubDummyAlg::finalize()
{

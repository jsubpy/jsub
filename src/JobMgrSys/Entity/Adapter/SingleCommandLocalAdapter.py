...
class SingleCommandLocalAdapter(Adapter):
    def __init__(self):
    ...
    def subAdapt(self, job_id, app_param, sub_job_param, repository):
        ...
        self.__createScript(script_path, output_dir, backend_param['command_path'], sub_job_param['args'])

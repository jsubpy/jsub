...
from jsub.manager.error import BackendNotSetupError, BadConfigError
import os
...
class ConfigManager(object):
	...
	def repo(self): #task data repository
		try:
			...
			raise BadConfigError("Error when loading jsubrc configuration (repo section). Bad format with it?")
	...
	def content(self): #raw task data
		try:
			...
			raise BadConfigError("Error when loading jsubrc configuration (content section). Bad format with it?")
	...
	def backend_data(self, task_profile):
		...
		try:
			...
			raise BadConfigError("Error when loading jsubrc configuration (backend section). Bad format with it?")
